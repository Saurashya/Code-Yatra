    ...
    <div>
        <nav className="h-[7vh] bg-black text-white font-light z-40 fixed w-[100vw]">
            <ul className='flex justify-around items-center h-[100%] w-[100%] text-xl cursor-pointer tracking-wide'>
                ...
                <li><button className='bg-orange-500 p-1 rounded-lg cursor-pointer px-3 font-semibold hover:bg-gradient-to-br from-purple-500 to-indigo-400'>Join Us</button></li>
            </ul>
        </nav>
    </div>
  )
